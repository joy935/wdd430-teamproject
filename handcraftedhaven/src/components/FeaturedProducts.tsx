    ...
    <section className="py-20 bg-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-xl mx-auto text-center mb-16">
          <span className="inline-block text-neonPinkDark font-semibold text-sm uppercase tracking-wider mb-2">
            Handpicked For You
          </span>
          ...
          <p className="text-gray-900 dark:text-gray-500">
            Discover our collection of unique, handcrafted treasures created with passion and skill by talented artisans.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative h-56 overflow-hidden">
                ...
                <div className="absolute top-3 left-3 z-20">
                  <span className="inline-block px-3 py-1 text-xs font-semibold bg-neonPinkDark text-white rounded-full shadow-md">
                    {product.category}
                  </span>
                </div>
              ...
              <div className="p-5">
                ...
                <div className="flex justify-between items-center mt-2">
                  <span className="text-lg font-semibold text-neonPinkDark">
